...
<div @click="HideContextMenu" id="AppropriabilitySubstrateDemo"
...
<!--
  ...
  @copy-button="Copy" @copy-all-button="CopyAll" @past-button="Past" @remove-button="Remove" @remove-all-button="RemoveAll"
  :need-past-button="false"></ContextMenu>
  </div>
 ...
 ChangeCenter(e){
  ...
  updateNaration(grp){
    ...
    if(grp.line.keepDistribution==true){
      text="<mark class='blue'> The Stickyline preserves alignment and distribution.</mark><br>";
    }else{
      ...
      this.$emit('explain',{origin:"Substrate - Appropriability",text:text});
  }
},
};
